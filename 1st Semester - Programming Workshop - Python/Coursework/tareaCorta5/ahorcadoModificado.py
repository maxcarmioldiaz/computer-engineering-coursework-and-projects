...
def esTextoValido(texto):
    ...
    return True
def palabraAdivinar():
    """Funcion que toma una palabra aleatoria de una lista y la retorna
    para indicar cual es la palabra que se tiene que adivinar en el juego.
    Entradas:
    ninguna
    Salidas:
    la palabra que el usuario va a adivinar.
    Restricciones:
    ninguna."""
    palabras = [
    "Costa Rica",
